...
namespace EasterRaces.Core.Entities
{
    public class ChampionshipController : IChampionshipController
    {
        ...
        public string CreateCar(string type, string model, int horsePower)
        {
            ...
            switch (type)
            {
                case nameof(MuscleCar): car = new MuscleCar(model, horsePower);
                    break;
                case nameof(SportsCar): car = new SportsCar(model, horsePower);
                    break;
            }
        ...
        public string StartRace(string raceName)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(ExceptionMessages.RaceInvalid, RaceMinParticipants));
            }
